...
impl TemplateData {
    ...
    fn get_serialized_empty_coinbase_outputs(&self) -> Result<B064KOwned, TemplateDataError> {
        ...
        let serialized_empty_coinbase_outputs: B064KOwned = serialized_empty_coinbase_outputs
            .try_into()
